...
: "${DDCLIENT_PROVIDER:?DDCLIENT_PROVIDER is required}"
...
: "${DDCLIENT_ZONE:?DDCLIENT_ZONE is required}"
: "${DDCLIENT_RECORD:?DDCLIENT_RECORD is required}"

API_HOST="${API_SUBDOMAIN}.${BASE_DOMAIN}"
CHAT_HOST="${CHAT_SUBDOMAIN}.${BASE_DOMAIN}"
export API_HOST CHAT_HOST MODEL_API_KEY DDCLIENT_DAEMON_SECONDS DDCLIENT_SSL DDCLIENT_USE DDCLIENT_WEB DDCLIENT_WEB_SKIP DDCLIENT_PROTOCOL DDCLIENT_PROVIDER DDCLIENT_LOGIN DDCLIENT_PASSWORD DDCLIENT_ZONE DDCLIENT_TTL DDCLIENT_RECORD
